...
class _PistachioVpnScreenState extends State<PistachioVpnScreen>
  ...
  // Ensures wireguard.initialize() is only ever called once, even if
  // triggered from both initState() and the connect button in quick
  // succession. Calling initialize() twice concurrently was causing a
  // bare `PlatformException(null, null, null, null)`.
  ...
  Future<void> _doInit() async {
    try {
      ...
      _initFuture = null; // allow a retry on the next attempt
    }
  }
